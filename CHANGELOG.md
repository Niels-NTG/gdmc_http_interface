...
- NEW: `POST /structure` endpoint now also accepts [SNBT-encoded](https://minecraft.fandom.com/wiki/NBT_format#SNBT_format) files.
...
- FIX: Requests to `PUT /blocks` are up to 70%[^1] faster!
